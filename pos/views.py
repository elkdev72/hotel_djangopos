...
from products.models import Room, Hotel
...
def index(request):
    ...
    top_products = Room.objects.annotate(quantity_sum=Sum(
    ...
    context = {
        ...
        "products": Room.objects.all().count(),
        "categories": Hotel.objects.all().count(),
